...
<div class="p-4">
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit Supplier</span>
        </div>
      </li>
    </ol>
  </nav>
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class=" mx-auto max-w-3xl">
      <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Data Supplier</h2>
